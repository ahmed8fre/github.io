...
* **Manzel App:**
    ...
    * **(Optional - Add after APK upload):** [Download the Demo Version (APK) here]([YOUR_APK_RELEASE_LINK_HERE](https://github.com/ahmed8fre/manzel-app/releases/download/manzel-app-demo/manzel-0.1.apk))
